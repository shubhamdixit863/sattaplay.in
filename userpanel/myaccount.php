          ...
          <div class="row">
            ...
            $stmt=$db->prepare("select password from users where username=:user");
             ...
             <div class="col-md-4">
               ...
               <input type="text" name="" value="<?php echo $result['password'] ?>" class="form-control" id="password">
            <input type="hidden" id="session" value="<?php echo $_SESSION['username']; ?>">
             </div>
