...
<div class="agile-grids">
          ...
          <input type="text" name="p_number" value="" class="form-control" required>
...
<form id="paytmform" method="post">
  <label for="">Name</label>
  <input type="text" name="pname" value="" class="form-control" placeholder="name" required>
    <label for="">Amount</label>
  <input type="text" name="pamount" value="" class="form-control" placeholder="Amount"  required>

  <label for="">Wallet</label>
  <select class="form-control" name="paytm" required>
  ...
  <label for="">Registered Number With Wallet</label>
  <input type="number" name="p_number" value="" required class="form-control">

    <input type="hidden" name="userid" value="<?php echo $_SESSION['username'] ?>">
    <input type="submit" name="" value="SUBMIT FOR TRANSFER" class="btn btn-block btn-info" style="margin-top:20px;">
</form>
              </div>
			</div>
...
<!-- Bootstrap Core JavaScript -->
 ...
 success:function(result){
   ...
   alert(result);
   window.location.href="redeemmoney.php";
   }
 ...
 $("#paytmform").on("submit",function(e){
 e.preventDefault();
 //var mydate=$("#hdatepicker").val();
 //var user=$("#huser_it").val();
 //alert(mydate);
